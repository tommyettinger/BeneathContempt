...
public class Effect {
  ...
  public static ObjectObjectOrderedMap<String, Effect> parseAll(List<String> lines) {
    if (lines == null || lines.isEmpty()) return new ObjectObjectOrderedMap<String, Effect>();
    ...
    ObjectObjectOrderedMap<String, Effect> all = new ObjectObjectOrderedMap<String, Effect>(numLines);
    for (int i = 1; i < numLines; i++) {
      String current = lines.get(i);
      Effect parsed = new Effect(TextTools.split(current, "\t"));
